                ...
                <div className="row ml-0 mr-0">
                  ...
                  >
                      <div className= "bg-facebook" style={{  height: 160, width: 292, borderRadius: 6 }}  >
                           <div className='row m-1 mt-3'>
                             <img
                                src={`assets/images/mentorz.png`}
                                alt="course"
                                className="col-4 pr-2 pl-3  "
                              />
                  ...
                  <div className="col-lg-12 pt-4 mb-3  pl-4">
                    <h2 className="fw-400 font-lg d-block">
                       <b className="text-facebook roboto-font text-orange2"> Các môn học THPT</b>
                  ...
                  <div className="col-lg-12 mt-3">
                    <Slider {...latestSlider}>
                      {latestList.map((value, index) => (
                        <div
                          className=" card card-img course-card w300 p-0 shadow-xss border-0 rounded-lg overflow-hidden mr-2 ml-2 mb-4"
                          key={index}
                        >
                          <div className="card-image w-100 mb-3">
                            <Link
